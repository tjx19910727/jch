...
class VReceive extends VCommon
{
    protected $rule = [
        ...
        "pic_out_goods_box" => "max:1000",
        "video_out_goods_box" => "max:1000",
        "video_refund_goods" => "max:1000",
        "item_ids" => "require",
    ...
    "maintainer_id" => "require",
        ...
        "staff_code" => "require|regex:/^[1-9][0-9]{5}([0-9]{2})?$/",
    ...
    protected $message = [
        ...
        "run_mode.require" => "VReceive.run_mode_require",
        "run_mode.in" => "VReceive.run_mode_in",
    "file_content.require" => "file_content不能为空",
    "per_row.integer" => "per_row格式错误",
        "staff_code.require" => "巡检账号不能为空",
        "staff_code.regex" => "巡检账号必须为首位非0的6位或8位数字",
