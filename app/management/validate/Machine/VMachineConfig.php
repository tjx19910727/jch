...
class VMachineConfig extends VCommon
{
    ...
    protected $scene = [
        "add" => ["m_id", "machine_id", "subcar_mix", "subcar_offline_sp_ids", "subcar_online_sp_ids"],
        "update" => ["mc_id", "subcar_mix", "subcar_offline_sp_ids", "subcar_online_sp_ids"],
        "del" => ["mc_id"],
        "updateMoreMc" => ["mcList"],
        "mcList" => ["m_id", "subcar_mix", "subcar_offline_sp_ids", "subcar_online_sp_ids"],
    ];

    public function sceneMcList()
    {
        return $this->only(['m_id', 'subcar_mix', 'subcar_offline_sp_ids', 'subcar_online_sp_ids'])
            ->remove("m_id",'unique');
    }
