...
class VMachineConfig extends VCommon
{
    ...
    protected $scene = [
        ...
        "update" => ["mc_id", "online_pay_success_tip", "add_other_org_goods", "run_mode", "subcar_mix", "goods_no_stock_jump_to_mini_program", "subcar_offline_sp_ids", "subcar_online_sp_ids"],
        "del" => ["mc_id"],
        "updateMoreMc" => ["mcList"],
        "mcList" => ["m_id", "online_pay_success_tip", "add_other_org_goods", "run_mode", "subcar_mix", "goods_no_stock_jump_to_mini_program", "subcar_offline_sp_ids", "subcar_online_sp_ids"],
    ];
