...
return [
    ...
    "VCard" => [
        ...
        "gift_balance_float" => "gift_balance format is invalid",
        "gift_balance_egt" => "gift_balance cannot be less than 0",
        "use_expire_in" => "use_expire is invalid",
        "expire_at_date" => "expire_at must be a unix timestamp and >= 0",
        "expire_at_require" => "expire_at is required when use_expire=1",
        "card_no_no_data" => "No card information found",
        "balance_not_enough" => "Card balance is not enough",
        "balance_amount_error" => "Invalid balance amount",
    ...
    "VSubMachine" => [
        ...
        "only_edge_add_channel" => "Only edge cabinets can add channels",
        "only_edge_del_channel" => "Only edge cabinets can delete channels",
        "bind_main_before_add_channel" => "Edge cabinet must bind a main cabinet before adding channels",
        "edge_channel_max_reached" => "Edge cabinet channels have reached the maximum of 3",
