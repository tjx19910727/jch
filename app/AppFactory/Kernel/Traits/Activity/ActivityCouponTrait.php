            ...
            if ($ac['designated_goods'] == 1) {
                ...
                if ($discount_price < $this->order['total_price']) {
                    ...
                    foreach ($this->order['details'] as $key => $value) {
                        ...
                        $sodDiscountPrice = bcmul($this->order['discount_price'],bcdiv($value['total_sod_price'],$totalPrice,2),3);
                        ...
                        $value['total_sod_price'] = bcsub($value['total_sod_price'], $sodDiscountPrice, 3);
