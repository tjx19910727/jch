...
VALUES(1, 5, 1, 1, 62, 3, 100.000, 1, 1, 1780990164, 1780990164);

INSERT INTO revenue_rule_item
(rri_id, rr_id, receiver_ao_id, ra_id, manager_id, calc_type, calc_value, sort, status, create_time, update_time)
VALUES(2, 6, 1, 1, 62, 3, 100.000, 1, 1, 1780990164, 1780990164);

INSERT INTO revenue_rule_item
(rri_id, rr_id, receiver_ao_id, ra_id, manager_id, calc_type, calc_value, sort, status, create_time, update_time)
VALUES(3, 7, 1, 2, 63, 1, 20.000, 1, 1, 1780990164, 1780990164);

INSERT INTO revenue_rule_item
(rri_id, rr_id, receiver_ao_id, ra_id, manager_id, calc_type, calc_value, sort, status, create_time, update_time)
VALUES(4, 7, 1, 3, 64, 1, 30.000, 2, 1, 1780990164, 1780990164);

INSERT INTO revenue_rule_item
(rri_id, rr_id, receiver_ao_id, ra_id, manager_id, calc_type, calc_value, sort, status, create_time, update_time)
VALUES(5, 8, 1, 1, 62, 4, 0.000, 1, 1, 1780990164, 1780990164);
...
VALUES(1, 5, 0.00, 5000.00, 10.000, 1, 1, 1780990177, 1780991494);

INSERT INTO revenue_rule_item_tier
(rrit_id, rri_id, threshold_min, threshold_max, calc_value, sort, status, create_time, update_time)
VALUES(2, 5, 5000.00, 8000.00, 20.000, 2, 1, 1780991494, 1780991494);

INSERT INTO revenue_rule_item_tier
(rrit_id, rri_id, threshold_min, threshold_max, calc_value, sort, status, create_time, update_time)
VALUES(3, 5, 8000.00, NULL, 30.000, 3, 1, 1780991511, 1780991511);

INSERT INTO revenue_rule_machine
(rr_id, m_id, ao_id, sort, status, create_time, update_time)
VALUES(5, 127, 1, 1, 1, 1780991511, 1780991511);
